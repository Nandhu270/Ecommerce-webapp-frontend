...
export default function Subscribe() {
  return (
    <div className="bg-success w-full py-10 px-6 mb-6 flex flex-col items-center justify-center text-center gap-4 rounded-2xl shadow-md">
      ...
      <form className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto justify-center items-center">
        ...
        />
        <button className="btn text-success rounded-xl p-3 px-5 text-sm sm:text-base">
          Subscribe
        </button>
      </form>
    </div>
